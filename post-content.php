<div class="col-md-12" id="post-<?php the_ID(); ?>" <?php post_class('kadima_blog_full'); ?>>
	...
	<div class="post-content-wrap">
		...
		<?php endif; ?>
		<div class="kadima_fuul_blog_detail_padding" style="background-color: #fff;">
		<h2 style="font-size:60px;font-weight:normal;"><?php if(!is_single()) {?><a href="<?php the_permalink(); ?>"><?php } ?><?php the_title(); ?></a></h2>
	...
	<ul class="blog-date-left" >
		<li class="kadima_post_date" style="background-color: #fff;">
